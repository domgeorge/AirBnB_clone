...
class TestReview_instantiation(unittest.TestCase):
    """
    Unittests for the testing instantiation of the Review class.
    """
    ...
    def test_str_representation(self):
        ...
        review = Review()
        review.id = "777777"
        review.created_at = review.updated_at = today_date
        review_str = review.__str__()
        self.assertIn("[Review] (777777)", review_str)
        self.assertIn("'id': '777777'", review_str)
        self.assertIn("'created_at': " + today_date_repr, review_str)
        self.assertIn("'updated_at': " + today_date_repr, review_str)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        review = Review(id="777", created_at=today_date_iso, updated_at=today_date_iso)
        self.assertEqual(review.id, "777")
        self.assertEqual(review.created_at, today_date)
        self.assertEqual(review.updated_at, today_date)
