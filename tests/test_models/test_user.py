...
class TestUser_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        user = User()
        user.id = "123456"
        user.created_at = user.updated_at = today_date
        user_str = user.__str__()
        self.assertIn("[User] (123456)", user_str)
        self.assertIn("'id': '123456'", user_str)
        self.assertIn("'created_at': " + today_date_repr, user_str)
        self.assertIn("'updated_at': " + today_date_repr, user_str)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        user = User(id="345", created_at=today_date_iso, updated_at=today_date_iso)
        self.assertEqual(user.id, "345")
        self.assertEqual(user.created_at, today_date)
        self.assertEqual(user.updated_at, today_date)
